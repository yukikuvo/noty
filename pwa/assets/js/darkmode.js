function enabler() {
  ...
  document.getElementsByClassName('linkadd')[0].style = "background: #1C2424";
  document.getElementsByClassName('btn-gtk-left')[0].style = "background: #1C2424";
  document.getElementsByClassName('btn-gtk-right')[0].style = "background: #1C2424";
  document.getElementsByClassName('btn-gtk-right')[1].style = "background: #1C2424";
